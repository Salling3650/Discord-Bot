...
#Command command start
    if message.content.startswith("!command"):
        Command = [
            "Deez", "Ligma", "Wilma", "TSP is a god", "!tank", "!fuck",
            "!simp", "!goodbye", "!depressed", "!yourmom", "I'm offended",
            "!penis"
        ]
        ...
        exit
        await message.channel.send(Command[2])
        exit
        await message.channel.send(Command[3])
        exit
        await message.channel.send(Command[4])
        exit
        await message.channel.send(Command[5])
        exit
        await message.channel.send(Command[6])
        exit
        await message.channel.send(Command[7])
        exit
        await message.channel.send(Command[8])
        exit
        await message.channel.send(Command[9])
        exit
        await message.channel.send(Command[10])
        exit
        await message.channel.send(Command[11])
        exit
#Command command end

#Dead chat command start
    if message.content.startswith("Dead chat"):
        await message.channel.send(
            f"Then talk instead of complaining {message.author.mention}")


#Dead chat command end
